## 1. Выбранный архитектурный стиль
...
### Пример пути эволюции архитектуры

```
Монолит → Монолит с чёткими модулями → Вынос модуля "Склад" → Вынос модуля "Платежи" → Микросервисы
```

Для магазина автозапчастей на практике эволюция чаще всего останавливается на первой или второй ступени, так как бизнес не требует сложной распределённой архитектуры.

---

## Вывод

Монолит выбран как оптимальный архитектурный стиль для магазина автозапчастей: он быстрый в разработке, дешёвый в поддержке и полностью покрывает требования проекта. Микросервисы убили бы проект сложностью, а чистый клиент-сервер с отдельным API избыточен до появления мобильного клиента.

---

*Дата выполнения: [укажите вашу дату]*  
*Студент: [укажите ваше имя]*
